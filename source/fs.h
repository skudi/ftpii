...
extern VIRTUAL_PARTITION *PA_DVD;
extern VIRTUAL_PARTITION *PA_WOD;
extern VIRTUAL_PARTITION *PA_FST;
extern VIRTUAL_PARTITION *PA_NAND;
extern VIRTUAL_PARTITION *PA_ISFS;
extern VIRTUAL_PARTITION *PA_OTP;
extern VIRTUAL_PARTITION *PA_SEEPROM;
